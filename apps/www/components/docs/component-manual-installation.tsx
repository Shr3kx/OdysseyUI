  ...
  const quotedDependencies = dependencies
    .map((dep) => {
      if (dep.startsWith('https://odysseyui.com/r/')) {
        return dep.replace('https://odysseyui.com/r/', '@odysseyui/');
      }
        ...
        <Step>
          ...
          <Collapsible open={isOpened} onOpenChange={setIsOpened}>
            <div ref={collapsibleRef} className="relative overflow-hidden">
              ...
              {!isOpened && (
                <div className="absolute inset-0 rounded-t-xl bg-linear-to-b from-neutral-300/30 to-white p-2 dark:from-neutral-700/30 dark:to-neutral-950">
