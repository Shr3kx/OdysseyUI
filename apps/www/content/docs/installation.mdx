...
<CodeTabs
  codes={{
    pnpm: `pnpm dlx shadcn@latest add @odysseyui/components-animate-code-block`,
    npm: `npx shadcn@latest add @odysseyui/components-animate-code-block`,
    yarn: `npx shadcn@latest add @odysseyui/components-animate-code-block`,
    bun: `bunx --bun shadcn@latest add @odysseyui/components-animate-code-block`,
  }}
/>
