---
title: Introduction
description: Use Odyssey UI components to animate your pages.
---

**Odyssey UI is a distribution of React components** built with [Tailwind CSS](https://tailwindcss.com/) and [Motion](https://motion.dev/), based on the shadcn registry and inspired by [shadcn/ui](https://ui.shadcn.com/) and [Magic UI](https://magicui.design/). Our goal is to help anyone add tasteful, accessible, Motion‑powered animation to their UI while keeping sites fast and maintainable.

## Not a library—an open component distribution

Like [shadcn/ui](https://ui.shadcn.com/), **Odyssey UI is not a typical install‑from‑NPM library**. It’s an open collection you can **copy, modify, and customize** directly in your codebase. This “open code” approach gives you maximum flexibility without wrapper overhead or styling workarounds.

## What’s included

1. **Primitives (animated)**: Building blocks with animation baked in. Authored by Odyssey UI or ported from popular primitive libraries (Radix UI, Base UI, Headless UI).
